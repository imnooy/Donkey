...
<head>
    ...
    <script>
        function checkForm() {
            ...
            if (document.getElementById("w_title").value.length >30) {
            ...
            if (document.getElementById("w_nickname").value.length >30) {
            ...
            if (document.getElementById("w_pw").value.length >30) {
